...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' => 'get12280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService',
            '2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' => 'get22280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService',
        ...
        $this->privates = array(
            '1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' => true,
            '2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab']) ? $this->services['1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab'] : $this->get12280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab']) ? $this->services['2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab'] : $this->get22280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d316b447c4a3ada40e6efde282370bd9f1feb839b15c58c9d5426070df01b60d');
    ...
    /**
     * Gets the private '1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get12280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService()
    {
        return $this->services['1_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get22280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530abService()
    {
        return $this->services['2_2280215caa2701e307d0df930a66deb409cff37318602613f1c1a12c3ac530ab'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2kaAurlLGM', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i+LGG9EAmO', 0, 'rfnv+wkx7qgdnHXbtOefTc', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('edjnIgWkU0', 0, 'rfnv+wkx7qgdnHXbtOefTc', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NY9JWp0oN-', 0, 'rfnv+wkx7qgdnHXbtOefTc', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a1fdff48b8428.85389022');
    }
